...
const isA = (tA: Type | FakeUnionOrIntersectionType, n: Node) => {
  ...
  return !isFakeUnionOrIntersectionType(tA) && tA.isObject() && tA.getProperties().length === 1 && prop !== undefined && prop.getTypeAtLocation(n).isString()
}
const isB = (tB: Type | FakeUnionOrIntersectionType, n: Node) => {
  ...
  return !isFakeUnionOrIntersectionType(tB) && tB.isObject() && tB.getProperties().length === 1 && prop !== undefined && prop.getTypeAtLocation(n).isNumber()
}
...
let simpleTests: Array<[string, (type: Type | FakeUnionOrIntersectionType, node: Node) => boolean]> = [
  ...
  ['boolean', (t) =>
    (!isFakeUnionOrIntersectionType(t) && t.isBoolean()) || (
      ...
      && t.join === 'union'
      && t.types.length === 2
      && t.types.every((ut, index) =>
        !isFakeUnionOrIntersectionType(ut)
        && ut.isBooleanLiteral()
        && (
          ut.getText() === ['false', 'true'][index]
          || ut.getText() === ['true', 'false'][index])
        )
    )
  ],
  ...
  ['string & {__brand: "a"}', (t, n) => {
    ...
    const isBrand = (tB: Type | FakeUnionOrIntersectionType, n: Node) => {
      ...
      return !isFakeUnionOrIntersectionType(tB) && tB.isObject() && tB.getProperties().length === 1 && prop !== undefined && propType !== undefined && propType.isStringLiteral() && propType.getText() === '"a"'
    }

    return types.length === 2 && types[0] !== undefined && types[1] !== undefined && (
  ...
  ['"a" | "b"', (t) => {
    ...
    return (
      ...
      && unionTypes.length === 2
      && unionTypes.every((ut, index) => !isFakeUnionOrIntersectionType(ut) && ut.isStringLiteral() && ut.getText() === ['"a"', '"b"'][index])
  }],
  ['[string, number]', (t) => {
    ...
    return t.isTuple() && tupleElements !== undefined && tupleElements.length === 2 && tupleElements[0] !== undefined && tupleElements[0].isString() && tupleElements[1] !== undefined && tupleElements[1].isNumber()
  }],
  ['{ a: string; b: number; }', (t, n) => {
    if (isFakeUnionOrIntersectionType(t)) {
      return false;
    }
  ...
  ['{ a: string; } & { b: number; }', (t, n) => {
    ...
    return types.length === 2 && types[0] !== undefined && types[1] !== undefined && (
      ...
      (isA(types[0], n) && isB(types[1], n))
      || (isA(types[1], n) && isB(types[0], n))
    );
  }],
  ['{ a: string; } & { b: number; } & { c: "c"; }', (t, n) => {
    const isC = (tC: Type | FakeUnionOrIntersectionType, n: Node) => {
      ...
      const propType = prop?.getTypeAtLocation(n);
      return !isFakeUnionOrIntersectionType(tC) && tC.isObject() && tC.getProperties().length === 1 && prop !== undefined && propType !== undefined && propType.isStringLiteral() && propType.getText() === '"c"'
    }

    const types = isFakeUnionOrIntersectionType(t) ? t.types : t.getIntersectionTypes();
    return types.length === 3 && types[0] !== undefined && types[1] !== undefined && types[2] !== undefined && (
      (isFakeUnionOrIntersectionType(t) && t.join === 'intersection')
      || (!isFakeUnionOrIntersectionType(t) && t.isIntersection())
    ) && (
