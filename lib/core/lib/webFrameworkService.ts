...
export interface WebFrameworkServiceType<HandlerFnParams extends any[]> {
  ...
  ) => Effect.Effect<unknown, RequestDoesNotContainError | RequestCannotAccessError, string>;
  ...
  readonly setHeader: (
    ...
    value: string,
    ...handlerFnParams: HandlerFnParams
  ) => Effect.Effect<unknown, ResponseCannotSetError, true>;
  readonly setCookie: (
    name: string,
    value: string,
    ...handlerFnParams: HandlerFnParams
  ...
  readonly sendJsonBody: (
    ...
    ...handlerFnParams: HandlerFnParams
  ) => Effect.Effect<unknown, ResponseCannotSetError | JsonSerializeError, true>;
  readonly sendFile: (
    statusCode: number,
